                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" onsubmit="return validate_form(this)">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"><input type="text" class="form-control" name="username" maxlength="16" ></div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">登陆密码</label>
                            <div class="col-sm-10"><input type="password" class="form-control" name="password" maxlength="16" ></div>
                        </div>
                                ...
                                foreach ($powers as $v) :
                                    ...
                                    if (!empty($v['child'])):
                                        foreach ($v['child'] as $v1) :
                                            ?>
                                            <label class="checkbox-inline"><input type="checkbox"  value="<?= $v1['actionid'] ?>" class="icheckbox<?= $v1['parentid']; ?>" name="powers[]"><?= $v1['description'] ?></label>
                                            <?php
                                        endforeach;
                                    endif
                                    ?>
