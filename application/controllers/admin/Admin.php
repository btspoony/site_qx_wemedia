...
class Admin extends DEFAULT_Controller {
    ...
    public function edit($admin_id = null) {
        ...
        if (!empty($data)) {
            ...
            $this->lib_common->redirect_modify('/admin/admin/see', !empty($row));
        }
    ...
    public function see($page = null) {
        $this->load->model('admin_model');
        $page_config = array(
            'base_url' => base_url('/admin/admin/see'),
        ...
        $this->load->view('/admin/admin/see', compact('data', 'page','model_config'));
    }
    ...
    public function add() {
        ...
        if (!empty($data)) {
            ...
            $this->lib_common->redirect_modify('/admin/admin/add', !empty($row));
        }
    ...
    public function modify_pwd() {
        ...
        if (!empty($data)) {
            ...
            $this->lib_common->redirect_modify('/admin/admin/modify_pwd', $flag);
        }
        $this->load->view('/admin/admin/modify_pwd');
    }
